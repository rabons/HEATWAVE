...
def plot_heatwave(filename, plottitle, color_boundaries, cbar_ticks):
    ...
    rasterfile = f"data/uae/{filename}.tiff"
    
    # Output file: use the base filename without folder path
    base_filename = os.path.basename(filename)
    outputfile = f"figures/uae/{base_filename}_cartopy.png"
    ...
    # Read boundary file
    boundaryfile_a0 = "data/boundaries/WB_gpkg/World Bank Official Boundaries - Admin 0 UAE.gpkg"
    boundaryfile_a1 = "data/boundaries/WB_gpkg/World Bank Official Boundaries - Admin 1 UAE.gpkg"
    boundaryfile_a2 = "data/boundaries/WB_gpkg/World Bank Official Boundaries - Admin 2 UAE.gpkg"
    ...
    # Color management
    colors = ["#FEFECB","#FBEB99","#F8DE85","#F4CC68","#F0BB5E","#EBA754","#E48650","#D1624C","#B8524A","#A44642","#8A3D3D","#72372E","#5A2E38","#40204D","#4D365B","#524261","#6B6370","#8C8A8E","#B5B5B8"]
    ncolors = 256
