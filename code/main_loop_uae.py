...
# Get all files in folder "Data/uae"
folder = "data/uae"
...
color_boundaries_mean_Tw = np.arange(15, 35.5, .5)
cbar_ticks_mean_Tw = np.arange(15, 36, 2)
...
color_boundaries_mean_T = np.arange(20, 50.5, .5)
cbar_ticks_mean_T = np.arange(16, 51, 2)
...
from plotting_uae import plot_heatwave
